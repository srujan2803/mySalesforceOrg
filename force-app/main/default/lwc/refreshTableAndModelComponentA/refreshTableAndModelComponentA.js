...
import getContacts from "@salesforce/apex/refreshApex.getContactsWithEmailAndAccount";
import { refreshApex } from '@salesforce/apex';

export default class RefreshTableAndModelComponentA extends LightningElement {
    @track contactRecId;
    @track conList=[];
